...
onready var background_frame = get_node("VBoxContainer/HBoxContainer/GridContainer/Background/VBoxContainer/background_frame")
...
func agregate(text_id):
	...
	text.background_frame = background_frame.get("range/value")
...
#	Gives the editor items the respective values based on the save
	...
	background_frame.set("range/value",contents[currentChapter][currentDialog][text_id].background_frame)
